...
#ifndef __SCAN_TOOLS_LASER_SCAN_ASSEMBLER_H__
#define __SCAN_TOOLS_LASER_SCAN_ASSEMBLER_H__
...
// Private includes
#include "scan_tools/laser_scan_assembler/traits.hpp"
 ...
 */
class RCLCPP_PUBLIC LaserScanAssembler: public rclcpp::Node {
...
public: /* ------------------------------------------------- Public ctors & dtors ------------------------------------------------- */
     ...
     */
    LaserScanAssembler(const rclcpp::NodeOptions & options);
