...
# @brief      Launchfile running middleware of the WUT Velmwheel robot's `bias_estimator` module
#    
#    
...
component_description = {
    ...
    'launch_arguments': {
        ...
        # Configuration file
        f'{component_name}_config': get_config_source('velmwheel_middleware_bringup', 'bias_estimator.yaml') ,
