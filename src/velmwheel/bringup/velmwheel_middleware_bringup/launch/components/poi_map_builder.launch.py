...
# @brief      Launchfile running middleware of the WUT Velmwheel robot's `poi_map_builder` module
#    
#    
...
component_name = 'poi_map_builder'

# ===================================================== Components descriptors ===================================================== #

# POI map builder node
component_description = {
    ...
    'launch_arguments': {
        ...
        # Configuration file
        f'{component_name}_config': get_config_source('velmwheel_middleware_bringup', 'poi_map_builder.yaml') ,
