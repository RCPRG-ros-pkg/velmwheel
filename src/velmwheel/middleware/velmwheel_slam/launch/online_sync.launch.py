...
# @brief
#    
#    Launchfile running the online synchronous SLAM agent from the SLAM toolbox package           
#
#     
...
def generate_launch_description():
    return generate_slam_component_launch_description(
        ...
        default_config_file = 'mapper_params_online_sync.yaml'
