 ...
 * @modified   Friday, 1st July 2022 7:10:33 pm
...
Imu<SlaveImplementationT>::get_gyro_temperatures() {
    ...
    return AxisValues {
        .x = imu::conversions::gyro_temperature_to_si(gyro_temperature_x_sdo.upload()),
        .y = imu::conversions::gyro_temperature_to_si(gyro_temperature_y_sdo.upload()),
        .z = imu::conversions::gyro_temperature_to_si(gyro_temperature_z_sdo.upload())
    };
