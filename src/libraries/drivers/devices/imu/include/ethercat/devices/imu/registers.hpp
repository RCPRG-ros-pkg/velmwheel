 ...
 * @modified   Friday, 1st July 2022 7:06:59 pm
...
constexpr Register ACCELEROMETER_BIAS_OFFSET_X{ 0x2202, "Accelerometer bias offset X", Type::UnsignedInt };
/// Description of the "Accelerometer bias offset Y" CoE register
constexpr Register ACCELEROMETER_BIAS_OFFSET_Y{ 0x2203, "Accelerometer bias offset Y", Type::UnsignedInt };
/// Description of the "Accelerometer bias offset Z" CoE register
constexpr Register ACCELEROMETER_BIAS_OFFSET_Z{ 0x2204, "Accelerometer bias offset Z", Type::UnsignedInt };
...
/**
 * @warning Note due to the [265a3f57455afba3e0bdd7979228cfaab50380dc] update commit of the original 
 *    [Imu-Ethercat-Software](https://github.com/RCPRG-ros-pkg/Imu-Ethercat-software) the 
 *    GYRO_RANGE_SETTINGS register is in fact not accessible via the EtherCAt bus. Instead,
 *    this register is fixed to the (?) (probably to the default value of the ADIS16400, but
 *    that's only a guess; this code is mess...)
 */
