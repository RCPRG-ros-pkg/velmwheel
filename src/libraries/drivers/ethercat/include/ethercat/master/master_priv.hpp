 ...
 * @modified   Monday, 13th June 2022 6:08:13 am
...
{ 
    // Clear PDI buffers
    std::fill(input_pdi.data.begin(),  input_pdi.data.end(),  static_cast<uint8_t>(0));
    std::fill(output_pdi.data.begin(), output_pdi.data.end(), static_cast<uint8_t>(0));
