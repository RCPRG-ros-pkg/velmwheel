                       ...
                       void*                  pvUser)
{
  ...
  ulCopySize  = min_macro( (sizeof(uSendPkt.tPacket.abData) - sizeof(uSendPkt.tFileDelete.tData)), uSendPkt.tFileDelete.tData.usFileNameLength);
                           ...
                           void*                 pvUser)
{
  ...
  *pfDownload = 1;
  ...
  ulCopySize  = min_macro( (sizeof(uSendPkt.tPacket.abData) - sizeof(uSendPkt.tRequest.tData)), uSendPkt.tRequest.tData.usFileNameLength);
  ...
  do
  {
    switch (ulState)
    {
      ...
      case HIL_FILE_DOWNLOAD_REQ:
      {
        ...
        uint32_t ulFileNameLength = min_macro( ((uint32_t)OS_Strlen(szFileName) + 1),
        ...
        ulCopySize  = min_macro( (sizeof(uSendPkt.tPacket.abData) - sizeof(uSendPkt.tDownloadReq.tData)), uSendPkt.tDownloadReq.tData.usFileNameLength);
                       ...
                       void*                   pvUser)
{
  ...
  ulCopySize  = min_macro( (sizeof(uSendPkt.tPacket.abData) - sizeof(uSendPkt.tUploadReq.tData)), uSendPkt.tUploadReq.tData.usFileNameLength);
