...
double Elmo<SlaveImplementationT>::get_position() const {
    ...
    if(position_pdo.has_value()) 
        ...
        return elmo::conversions::motor_encoder_to_gearing_rad(config, position_pdo.get());
...
double Elmo<SlaveImplementationT>::get_velocity() const {
    ...
    if(velocity_pdo.has_value()) 
        ...
        return elmo::conversions::motor_encoder_to_gearing_rad_vel(config, velocity_pdo.get());
...
double Elmo<SlaveImplementationT>::get_torque() const {
    ...
    if(torque_pdo.has_value()) 
        ...
        return elmo::conversions::motor_torque_to_gearing_torque(config, torque_pdo.get());
...
double Elmo<SlaveImplementationT>::get_current() const {
    ...
    if(current_pdo.has_value()) 
        ...
        return elmo::conversions::reg_to_motor_current(config, current_pdo.get());
