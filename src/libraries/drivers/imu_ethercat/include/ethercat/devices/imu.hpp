 ...
 * @modified   Monday, 13th June 2022 2:49:26 pm
...
public: /* ------------------------------------------------- Public I/O methods -------------------------------------------------- */
    ...
    /// Reads configuration of the gyro sensors' range from the device
    GyroRange read_gyro_range();
    /// Writes configuration of the gyro sensors' range to the device
...
private: /* -------------------------------------------- Private conversion methods ---------------------------------------------- */
     ...
     */
    static constexpr double acceleration_measurement_to_si(int16_t measurement);
     ...
     */
    static constexpr int16_t si_to_acceleration_measurement(double measurement);
     ...
     */
    static constexpr double acceleration_calib_to_si(uint16_t calibration);
     ...
     */
    static constexpr uint16_t si_to_acceleration_calib(double calibration);
     ...
     */
    static constexpr double gyro_measurement_to_si(GyroRange range_config, int16_t measurement);
     ...
     */
    static constexpr int16_t si_to_gyro_measurement(GyroRange range_config, double measurement);
     ...
     */
    static constexpr double gyro_calib_to_si(uint16_t calibration);
     ...
     *     @p calibration converted to sensor-specific units
     */
    static constexpr uint16_t si_to_gyro_calib(double calibration);
     ...
     */
    static constexpr double gyro_temperature_to_si(uint16_t temperature);
