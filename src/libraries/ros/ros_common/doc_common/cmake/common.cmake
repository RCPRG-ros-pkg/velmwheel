...
# @modified   Wednesday, 25th May 2022 2:16:57 pm
...
# ----------------------------------------------------------------------------------
macro(_node_common_set_default var default)
    if(NOT ${var})
        set(${var} ${default})
    endif()
endmacro()
...
# ----------------------------------------------------------------------------------
macro(_node_common_parse_with_default var_in default var_out)
    if(NOT ${var_in})
        set(${var_out} ${default})
    else()
        set(${var_out} ${${var_in}})
...
# ----------------------------------------------------------------------------------
macro(_node_common_parse_arg arg default)
    _node_common_parse_with_default(${ARG_PREFIX}_${arg} ${default} ${arg})
endmacro()
...
# ----------------------------------------------------------------------------------
macro(_node_common_strip_arg arg)
    if(${ARG_PREFIX}_${arg})
